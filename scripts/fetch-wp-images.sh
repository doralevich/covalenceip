...
for f in \
  ...
  2024/01/Group-4.svg 2024/01/Group-5.svg 2024/01/Clip-path-group-1.svg \
  2024/01/Group-1-2.svg 2024/01/Group-2-1.svg 2024/01/image-1-1.svg 2024/01/image-2-1.svg \
